function addNewUser()
{
    ...
    var posting = $.post( "/admin/users", "addAdmUsrFlag=y&newUsrName="+$("[name='newUsrName']").val()+"&newUsrPass="+$("[name='newUsrPass']").val());
    ...
    posting.done(function( data ) {
        ...
        if(response.result == true){
            ...
            $.get( "/admin/users", {action: "refreshUsers"} )
...
function dropAdminUsr(usrName)
{
    ...
    $.get( "/admin/users", {dropUser: usrName} )
        .done(function( data ) {
            $('.usersList').html(data);
