...
class View_JointSite_About_Api extends View_JointSite_About
{
    ...
    protected static function pageContentJointSite(\stdClass $contentBlock, string $langSl = ''):string
    {
        return '<section>'.
            ...
            '</p>'.
            '<p>'.
            'Для доступа к Module api требуется авторизация, постому что доступы могут быть назначенны только на созданные '.
            'пользователем объяекты и ModuleModel работает с полем created_by. '.
