...
class View_JointSite_About extends View_JointSite
{
    ...
    {
        return '<section>'.
            'Это тренировочный проект, который может быть использован и для реальных задач. '.
            'При проектировании приложение задумывалось как двуязычный сайт для решения широкого круга задач. '.
            'Основные требования были - простота и скорость разработки нового фунционала на основе спроектированного коркаса. '.
            'Сайт поддерживает стандартные интерфейсы psr и может быть интегрирован с другими решениями. '.
            'Простота в настройке доступа пользователей.'.
            '</section>'.
            '<section>'.
            '<p>Для работы с таблицами</p>'.
            '<p>проведение миграций</p>'.
            '<p>работа с записями</p>'.
            '<p>работа с модулем</p>'.
            '<p>оповещение пользователей</p>'.
            '</section>';
