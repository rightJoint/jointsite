...
class View_JointSite_About extends View_JointSite
{
    ...
    protected static function pageContentJointSite(\stdClass $contentBlock):string
    {
        return '<section>'.
            ...
            'При проектировании приложение задумывалось как двуязычный сайт для решения широкого круга задач. '.
            'Основные требования были - простота и скорость разработки нового фунционала на основе спроектированного каркаса. '.
            '</section>'.
            '<section>'.
            '<h2>Records Model</h2>'.
            '<h3>Работа с таблицами</h3>'.
            '<p>Для работы с таблицами я использую свой свой контролер и модель, <a href="/test/records">пример</a>, '.
            'для небольшой базы данных этого достаточно, '.
            'хотя я знаком с phpMyAdmin.</p>'.
            '<p></p>'.
            '<h3>проведение миграций</h3>'.
            '<p><strong>!!!проведение миграций через коммандную строку</strong></p>'.
            '<p>Также я провожу миграции через веб-интерфейс <a href="/test/migration">пример</a>'.
            'Который позволяет редактировать предустановленные тип запросов в sql-файлах миграций, '.
            'следить за выполением миграций в логах</p>'.
            //'<p>Для работы с таблицами</p>'.
            '<h3>работа с записями</h3>'.
            '<p>Для работы с записями в таблицах реализован тестовый пример  <a href="/test/records">пример</a></p>'.
