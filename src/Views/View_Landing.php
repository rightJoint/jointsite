...
class View_Landing extends SiteView
{
    ...
    public static function createPageContent(\stdClass $langPageContent, \stdClass $viewParams):string
    {
        return
            ...
            self::printBlogCards($langPageContent->artLang, $viewParams->artList).
            '</div></div></div>'.
    ...
    public static function printBlogCards(\stdClass $artLang, array $artList):string
    {
        $return = '';
        ...
        foreach($artList as $num => $slArt_row){
            //($slArt_row = $inclContent->fetch(PDO::FETCH_ASSOC)){

            $ref=null;
            //$blogT = null;
            //if($slArt_row['artCat_id']==3){
            //    $ref="dev";
             //   $blogT = "<span class='bWeb'>WEB-блог</span>";
            //}elseif ($slArt_row['artCat_id']==1){
            //    $ref="pc";
                $blogT = "<span class='bPc'>ПК-Блог</span>";
            //}


            $blog_arts.="<article class='mini-card module module-article article'>".
                "<div class='pubDate'>".
                //"<time datetime='2021-01-15' title='Originally published Jan 15, 2021'>".
                "Статья";
            ...
            $blog_arts.="</div><h4 class='mini-card-title'>".
                "<a href='/".$ref."/".$slArt_row['artRef']."'>".$slArt_row['artName']."</a>".
                "</h4>".
            ...
            if($slArt_row['artImg']){
                ...
                //"<img src='".ARTS_IMG_PAPH.$slArt_row['art_id']."/preview/".$slArt_row['artImg']."'>";
            }else{
        ...
        $return.= '<div class="popular-articles">'.
            ...
            '<span>Web-блог ('.$artsDev_cnt.')</span>'.
            '<span>ПК-блог ('.$artsPc_cnt.')</span>'.
            '</div>'.
            '</div>'.
