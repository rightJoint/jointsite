...
trait RoutesCollection_Music
{
    static function getRoute_Music($routes_ns):JointSiteRoute
    {
        ...
        //GET: /music/playalbum
        elseif(strtolower($routes_ns[2]) == 'playalbum'){

            $route
                ->withController('Src\Controllers\Controller_Music', ['playAlbName' => $routes_ns[3]])
                ->withModel('Src\Models\Music\Model_Music_Albums')
                ->withAction('actionPlayAlbum')
                ->withView('Src\Views\Music\View_Music_PlayAlb');
