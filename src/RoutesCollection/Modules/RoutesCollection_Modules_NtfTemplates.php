...
trait RoutesCollection_Modules_NtfTemplates
{
    //GET: /siteman/ntftemplates
    static function getRoute_ModuleNtfTemplates($routes_ns):JointSiteRoute
    {
        $route = (new JointSiteRoute())
            ->withController('JointApp\Controllers\Components\Controller_Components_NtfTemplates',
            //array('processUri' => '/test/migrations/migrationsList')
            )
            ->withModel('JointApp\Models\Components\Model_Components_NtfTemplates');
        /*
        ...
        */
        ...
        //GET: /siteman/ntftemplates.../listview
        ...
        //GET: /siteman/ntftemplates/detailview
        ...
        //GET: /siteman/ntftemplates/editview
        ...
        //GET: /siteman/ntftemplates/newview
    ...
    //POST: /siteman/users
    static function postRoute_ModuleNtfTemplates($routes_ns):JointSiteRoute
    {
        $route = (new JointSiteRoute())
            ->withController('JointApp\Controllers\Components\Controller_Components_NtfTemplates',
            //array('processUri' => '/test/migrations/migrationsList')
        ...
        //POST: /siteman/ntftemplates..listview
        if (!isset($routes_ns[3]) or strtolower($routes_ns[3]) == 'listview') {
            $route
        ...
        //POST: /siteman/ntftemplates/editview
        elseif (strtolower($routes_ns[3]) == 'editview') {
            $route
                //->withAction('detailTopPanel')
        ...
        //POST: /siteman/ntftemplates/deleteview
        elseif (strtolower($routes_ns[3]) == 'deleteview') {
            $route
        ...
        //POST: /siteman/ntftemplates/newview
        elseif (strtolower($routes_ns[3]) == 'newview') {
            $route
