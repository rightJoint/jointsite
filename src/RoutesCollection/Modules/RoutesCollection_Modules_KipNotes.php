...
trait RoutesCollection_Modules_KipNotes
{
    //GET: /siteman/kipnotes
    static function getRoute_ModuleKipNotes($routes_ns):JointSiteRoute
    {
        $route = (new JointSiteRoute())
            ->withController('JointApp\Controllers\Components\Controller_Components_KipNotes',
            )
            ->withModel('JointApp\Models\Components\Model_Components_KipNotes');
        //GET: /siteman/kipnotes.../listview
    ...
    //POST: /siteman/kipnotes
    static function postRoute_ModuleKipNotes($routes_ns):JointSiteRoute
    {
        $route = (new JointSiteRoute())
            ->withController('JointApp\Controllers\Components\Controller_Components_KipNotes', )
            ->withModel('JointApp\Models\Components\Model_Components_KipNotes');
        //POST: /siteman/kipnotes..listview
        if (!isset($routes_ns[3]) or strtolower($routes_ns[3]) == 'listview') {
            $route
        ...
        //POST: /siteman/kipnotes/editview
        elseif (strtolower($routes_ns[3]) == 'editview') {
            $route
                ->withAction('postEditView')
                ->withView('JointApp\Views\Modules\ModuleEditView');
        }
        //POST: /siteman/kipnotes/deleteview
        elseif (strtolower($routes_ns[3]) == 'deleteview') {
            $route
                ->withAction('postDeleteView')
                ->withView('JointApp\Views\Modules\ModuleEditView');
        }
        //POST: /siteman/kipnotes/newview
        elseif (strtolower($routes_ns[3]) == 'newview') {
            $route
