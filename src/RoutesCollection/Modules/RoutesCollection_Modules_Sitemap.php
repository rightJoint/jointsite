...
trait RoutesCollection_Modules_Sitemap
{
    //GET: /siteman/sitemap
    static function getRoute_ModuleSitemap($routes_ns):JointSiteRoute
    {
        ...
        */
        ...
        //GET: /siteman/sitemap/detailview
    ...
    //POST: /siteman/sitemap
    static function postRoute_ModuleSitemap($routes_ns):JointSiteRoute
    {
        $route = (new JointSiteRoute())
            ->withController('JointApp\Controllers\Components\Controller_Components_Sitemap',
            //array('processUri' => '/test/migrations/migrationsList')
        ...
        //POST: /siteman/sitemap/deleteview
        elseif (strtolower($routes_ns[3]) == 'deleteview') {
            $route
