...
trait RoutesCollection_Modules_User
{
    //GET: /siteman/users
    static function getRoute_ModuleUsers($routes_ns):JointSiteRoute
    {
        $route = (new JointSiteRoute())
            ->withController('JointApp\Controllers\Components\Controller_Components_Users',
            //array('processUri' => '/test/migrations/migrationsList')
            )
            ->withModel('JointApp\Models\Components\Model_Components_User');
/*
...
*/
    ...
    //POST: /siteman/users
    static function postRoute_ModuleUsers($routes_ns):JointSiteRoute
    {
        $route = (new JointSiteRoute())
            ->withController('JointApp\Controllers\Components\Controller_Components_Users',
                //array('processUri' => '/test/migrations/migrationsList')
