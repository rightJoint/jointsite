...
trait RoutesCollection_Modules_NtfList
{
    //GET: /siteman/groups
    static function getRoute_ModuleNtfList($routes_ns):JointSiteRoute
    {
        $route = (new JointSiteRoute())
            ->withController('JointApp\Controllers\Components\Controller_Components_NtfList',
            //array('processUri' => '/test/migrations/migrationsList')
            )
            ->withModel('JointApp\Models\Components\Model_Components_NtfList');
        /*
    ...
    //POST: /siteman/users
    static function postRoute_ModuleNtfList($routes_ns):JointSiteRoute
    {
        $route = (new JointSiteRoute())
            ->withController('JointApp\Controllers\Components\Controller_Components_NtfList',
            //array('processUri' => '/test/migrations/migrationsList')
