...
use Src\RoutesCollection\Modules\RoutesCollection_Modules_KipReport;
...
trait RoutesCollection_Siteman
{
    ...
    use RoutesCollection_Modules_KipReport;
    ...
    static function getRoute_Siteman($routes_ns):JointSiteRoute
    {
        ...
        elseif (strtolower($routes_ns[2]) == 'kipreport'){
            $route = self::getRoute_ModuleKipReport($routes_ns);
        }
        return $route;
    }
    static function postRoute_Siteman($routes_ns):JointSiteRoute
    {
        ...
        elseif (strtolower($routes_ns[2]) == 'kipreport'){
            $route = self::postRoute_ModuleKipReport($routes_ns);
        }
        return $route;
    }
}