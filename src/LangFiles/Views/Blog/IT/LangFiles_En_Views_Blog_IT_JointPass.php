<?php
class LangFiles_En_Views_Blog_IT_JointPass extends LangFiles_En_Views_BlogArts
{
    static public function getLangArtContent():\stdClass
    {
        ...
        $langArtContent->product_info = $product_info;

        $jp_feedback = array(
            "p1" => "If you have any other questions about jointPass, please text me on my eMail",
        );
        $langArtContent->jp_feedback = $jp_feedback;
        ...
        $langArtContent->jp_craft = $jp_craft;
