<?php
class LangFiles_Ru_Views_Blog_IT_TestTaskPhpJob extends LangFiles_Ru_Views_BlogArts
{
    ...
    static public function getLangArtAnalysis():\stdClass
    {
        ...
        $analysis->p1 = 'Задание мне было выдано в виде ms-word <a href="/userdata/blog/IT/bookshop_ru.txt" title="скачать задание">документа</a> и при
