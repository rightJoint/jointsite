<?php
class LangFiles_Ru_Views_Test_Migrations_ExecNew extends LangFiles_Ru_Views_Test_Migrations
{
    static public function getLangHead():stdClass
    {
        $langHead = parent::getLangHead();
        $langHead->description = 'Тесты-провести миграции';
        $langHead->title = 'Тесты-провести миграции';
    ...
    static public function getLangHeader():stdClass
    {
        ...
        $langHeader->h1 = 'Тесты-провести миграции';
