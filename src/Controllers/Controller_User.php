...
use JointApp\Notifications\NotificationMailModel;
use JointApp\PhpMailerConfig;
use JointApp\Records\RecordsController;
use JointApp\Views\SiteView;
use PHPMailer\PHPMailer\PHPMailer;
use Src\Views\User\View_User_SignIn;


class Controller_User extends Controller //extends RecordsController
{
    ...
    public function actionPostSignUp()
    {
        ...
        if($this->callSignUp){
            ...
            //$this->model->record["accLogin"]["curVal"] = $this->requestParams['signUpLogin'];
