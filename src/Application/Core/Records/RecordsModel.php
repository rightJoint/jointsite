...
class RecordsModel extends Model_Pdo implements RecordsModelInterface
{
    ...
    {
        parent::loadLangModel(); // TODO: Change the autogenerated stub
        require_once JOINT_SITE_REQ_LANG."/Models/LangFiles_".JOINT_SITE_NS_LANG."_Models_RecordModel.php";
        return "LangFiles_".JOINT_SITE_NS_LANG."_Models_RecordModel";
    }
    ...
    public function getRecordStructure()
    {
        ...
        if($datatype_res  = $this->pdoQuery("SELECT * from INFORMATION_SCHEMA.COLUMNS ".
            ...
            if($datatype_res->rowCount()){
                ...
                return $this->logger->alert($this->lang_map->table_name_not_found." _".$this->conn_db."_: table_name='".$this->tableName."', ".
                "/core/RecordsModel->getRecordStructure", $this->logger->logger_context);
            }
        }else{
            return $this->logger->alert("RecordsModel throw err: ".$this->lang_map->table_name_not_found.": db_name '".$this->sql_db_name."'".
