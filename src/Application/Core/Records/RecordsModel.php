...
class RecordsModel extends Model_pdo implements RecordsModelInterface
{
    ...
    function loadLangModel():string
    {
        ...
        require_once JOINT_SITE_REQ_LANG."/Models/LangFiles_".JOINT_SITE_APP_LANG."_Models_RecordModel.php";
        return "LangFiles_".JOINT_SITE_APP_LANG."_Models_RecordModel";
    }
