...
{
    public $process_path = JOINT_SITE_EXEC_DIR.JOINT_SITE_APP_REF."/api/records";
    ...
    {
        $this->process_path = JOINT_SITE_EXEC_DIR.JOINT_SITE_APP_REF."/api/records";
    ...
    {
        $this->records_process(JOINT_SITE_EXEC_DIR.JOINT_SITE_APP_REF."/api/records/users_dt", "migration_log", null);
    }
