...
class lang_view_jointsite_admin_rus extends lang_view_products_jointsite_rus
{
    function __construct()
    {
        ...
        $this->product_config["p3"] = "Меню админки настроено на тестовый пример, чтоб настроить меню на адрес <span class='ex-conf'>/admin</span>, ".
        ...
        $this->product_config["p5"] = "По умолчанию админка настроена на адрес <span class='ex-conf'>/test/phpmysqladmin</span>. ";
        ...
        $this->prod_test = array(
            "p1" => "Для теста Админка представлена на <a href='".JOINT_SITE_EXEC_DIR."/admin'>".JOINT_SITE_EXEC_DIR."/admin</a>".
