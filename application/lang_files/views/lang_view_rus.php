        ...
        "branches" => array(
            "menu_items" => array(
                "record" => array(
                    ...
                    "more" => "<a href='".JOINT_SITE_LANG_REF."/products/jointsite/record' title='узнать подробнее про Запись'>подробнее</a>",
                ...
                "main" => array(
                    ...
                    "more" => "<a href='".JOINT_SITE_LANG_REF."/products/jointsite/main' title='узнать подробнее про Запись'>подробнее</a>",
                    "depend" => "нет звисимостей",
                ),
            ),
        ),
