...
class lang_view_jointsite_main_en extends lang_view_products_jointsite_en
{
    function __construct()
    {
        ...
        $this->head["h1"] = "Web-application ДжойнтСайт";
        $this->head["title"] = "Branch main";

        $this->head["description"] = $this->head["h1"].". ".$this->head["title"];

        $this->product_custom["p1"] = "This php app supported mvc pattern. ".
            "Core-branch main contains main templates for quick launch new theme-branches. ".
