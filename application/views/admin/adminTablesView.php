<?php
class AdminTablesView extends AdminView
{
    public $tables = null;

    function __construct()
    {
        $this->lang_map["admin_tables"] = array(
            "pefix" => array(
                "en" => "pefix",
                "rus" => "Приставка",
            ),
        ...
        $this->styles[] = "/css/admin/tables.css";
        ...
        $this->scripts[] = "/js/admin/tables.js";
    ...
    function print_page_content()
    {
        echo "<div class='contentBlock-frame admin'><div class='contentBlock-center'><div class='contentBlock-wrap'>".
            ...
            "<label for='prefixTag'>".$this->lang_map["admin_tables"]["pefix"][$_SESSION["lang"]]."</label><input type='text' id='prefixTag' name='prefixTag'>".
            "<label for='dateTag'>".$this->lang_map["admin_tables"]["dateTag"][$_SESSION["lang"]]."</label>".
            "<input type='checkbox' id='dateTag' name='dateTag' checked>".
            "</div>".
            "<div class='btnPanel'>".
            "<input type='button' class='uploadAll' value='".$this->lang_map["admin_tables"]["btn_upLoadAll"][$_SESSION["lang"]]."' onclick='upLoadAll()'>".
            "<input type='button' class='refresh' value='".$this->lang_map["admin_tables"]["btn_refresh"][$_SESSION["lang"]]."' onclick='refreshTables()'>".
            "<input type='button' class='showLog' value='".$this->lang_map["admin_tables"]["btn_log"][$_SESSION["lang"]]."' onclick='showLog()'>".
            "</div></div>".
            "</div></div></div>".
        ...
        echo "</div></div></div></div>".
            ...
            "<div class='logPanel'><h3>".$this->lang_map["admin_tables"]["h3"][$_SESSION["lang"]].":</h3></div>".
            "</div></div></div>";
    }
    ...
    function tables_list()
    {
        echo "<div class='table-line caption'><div class='table-cell tblName'>".
            $this->lang_map["admin_tables"]["t_cap"]["table"][$_SESSION["lang"]].
            "</div>".
            "<div class='table-cell tblLst'>".
            $this->lang_map["admin_tables"]["t_cap"]["Lst"][$_SESSION["lang"]].
            "</div>".
            "<div class='table-cell tblExt'>".
            $this->lang_map["admin_tables"]["t_cap"]["Ext"][$_SESSION["lang"]].
            "</div>".
            "<div class='table-cell tblAct'>".
            $this->lang_map["admin_tables"]["t_cap"]["action"][$_SESSION["lang"]].
            "</div><div class='table-cell tblDwlTag'>".
            $this->lang_map["admin_tables"]["t_cap"]["tgt"][$_SESSION["lang"]].
            "</div></div>";
    ...
    static function print_date_stamp()
    {
        ...
        return date( 'Y-m-d H:i:s').'</br>'.
            $lead_time[$_SESSION["lang"]].": ".($end_time-$mct['start_time']);
    }
}