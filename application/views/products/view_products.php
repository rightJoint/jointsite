    ...
    function __construct()
    {
        ...
        $this->lang_map["jointsite"] = array(
            ...
            "p4" => array(
                "en" => "adasdwdwdwed",
                "rus" => "<ul>".
                    "<li>Admin - утилита для работы с mysql базой танных и записями в таблицах</li>".
        ...
        $this->lang_map["jointpass"] = array(
            ...
            "p1" => array(
                "en" => "adasdwdwdwed",
                "rus" => "Упорядоченное и безопасное хранение паролей. ".
                    "Вам не придется помнить пароли от всех ваших учеток, достаточно помнить один МастерПасс от программы. ",
            ),
            "p2" => array(
                "en" => "adasdwdwdwed",
                "rus" => "Нажмите на строку учетки в таблице и кнопки копирования логина и пароля сразу доступны на панели. ".
                    "Все данные шифруются и хранятся на вашем жестком диске. Вы можете распределить ваши учетки на группы и категории.",
            ),
            "p3" => array(
                "en" => "adasdwdwdwed",
