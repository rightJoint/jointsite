...
class productSiteModuleView extends productSiteView
{
    ...
    function prod_info_custom(){
        ...
        echo "<p>Ветка Модуль или управление сайтом наследуется от ветки Запись, дополняет существующие методы групповыми операциями и ".
            ...
            "<p>Для входа в Управление сайтом требуется авторизация на сайте.</p>".
            ...
            "</div>".
            "</div>".
            "<p>Личный кабинет доступен по url <span class='ex-conf'>/user</span>, ссылка на него появится в меню после авторизации.</p>".
            "<div class='example eximg'>".
            "<div class='example-img'>".
            ...
            "<p>Доступ к модую задается для групп в конфигурации модуля. ".
            "Для включения доступа пользователя к модулю, его надо добавить в соответствующую группу. ".
            "Отдельно для пользователя задаются уровни доступа в группе (создание, удаление, просмотр и редактирование)</p>".
            "<p>Права пользователя на модуль применяются ко всем таблицам модуля по полю created_by в таблице. ".
            "Если доступ к модулю настроен для нескольких групп, то применяются максимальные права из всех групп пользователя.</p>".
            "<p>Для включенния полного доступа без учета групп надо использовать настройку <span class='ex-conf'>админ</span> у пользователя.</p>".
            "<h3>Уведомления</h3>".
            "<p>Отправка уведомлений настроена в коде (заглушка для отправки уведомлений).</p>".
    ...
    function prod_deploy_migrations()
    {
        ...
        echo "<div class='example eximg'>".
            ...
            "<p>Вам надо создать таблицы. Запросы на создание таблиц расположены по умолчанию в каталоге <span class='ex-conf'>__config/admin/createTablesQueries</span></p>".
            "<ul>".
            "<li>users_dt</li>".
            ...
            "<li>ntflist_dt</li>".
            "</ul>".
            "<p>Добавление данных в таблицы. Запросы на добавление данных в таблице по умолчанию в каталоге <span class='ex-conf'>usrdata/db</span></p>".
            "<ul>".
    ...
    function prod_deploy_config()
    {
        ...
        echo "<p>".
            "Дополнительно устанавлюваются еще две настройки".
            "<ul>".
