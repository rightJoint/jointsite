...
class productJointPassView extends View
{
    ...
    function prod_info_custom()
    {
        ...
        echo "<div class='branches-block'>".
            ...
            "</p>".
            "<p>".
            "Иногда вы можете захотеть изменить MasterPass, для этого нажмите изменить пароль в левом нижнем ".
            ...
            "<p>".
            "Группы и категории предназначены для классификации и фильтрации учетных записей, единственное различие в том что ".
    ...
    function prod_craft()
    {
        echo "<div class='contentBlock-frame'><div class='contentBlock-center'>".
            ...
            "<p>".
            "При авторизации программа читает файл <span class='ex-conf'>jPass.ini</span> из каталога запуска и берет из него соль (обычный GUID), ".
            ...
            "</p>".
            "<p>".
            "Введеный при входе в программу МастерПасс хранится в оперативной памяти на время работы программы ".
            ...
            "</div>".
            "<div class='example-text'>".
            "Пример шифрования слова <span class='ex-conf'>silver</span> на МастерПасс <span class='ex-conf'>123</span>".
            "</div>".
            "</div>".
            ...
            "<p>".
            "Папка с данными программы задается в <span class='ex-conf'>jPass.ini</span> по умолчанию ".
            ...
            "</div>".
            "<p>".
            "<strong>Для применения изменений файл accounts.jpass каждый раз перезаписывается целиком. Для теста использовал 25 учеток, ".
