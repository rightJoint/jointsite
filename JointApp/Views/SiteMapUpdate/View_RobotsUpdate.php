...
class View_RobotsUpdate extends SiteView
{
    public string $logo = '/img/popimg/no-index.png';
    public string $shortcutIcon = '/img/popimg/no-index.png';
    ...
    {
        $name = 'LangFiles_'.self::langNs($viewLang).'_Views_RobotsUpdate';
    ...
    public static function getLangMap():string
    {
        return '<div class="contentBlock-frame"><div class="contentBlock-center">'.
            ...
            '<a href="/robots.txt" title="sitemap.xml">robots.txt</a>'.
            '</div></div></div>';
    }
}